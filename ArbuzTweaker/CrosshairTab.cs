...
public sealed class CrosshairTab : UserControl
{
    ...
    private void InitializeComponent()
    {
        ...
        {
            Text = "Нажмите «Включить прицел». Если прицел уже включён, форма, размер и цвет меняются сразу. В эксклюзивном полноэкранном режиме оверлей может работать некорректно; для стабильной работы лучше использовать оконный режим без рамки.",
            Font = new Font("Segoe UI", 10F, FontStyle.Regular),
