...
/// <summary>
/// Вкладка оптимизации Windows. Каждый пункт показывает честную оценку влияния:
...
public sealed class PcTuningTab : UserControl
{
    ...
    private void InitializeComponent()
    {
        ...
        {
            Text = "Твики для снижения задержек, устранения фризов и очистки фона. "
                 + "У каждого пункта указано, что он делает и влияет ли на производительность: "
